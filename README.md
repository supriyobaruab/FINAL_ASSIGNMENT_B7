...
4. Now, write a C++ program that demonstrates how to create two objects of Parallelogram class using default and parameterized constructors, set parallelogram information, and access it using the getter functions. Finally calculate and then show the parallelogram area. 
...
5. Design a C++ class named Customer to represent a Customer’s initial balance and calculate its balance with interest. The Customer class should have some attributes and it should also have the following member functions: 
